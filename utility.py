...
class InputValidator:
    ...
    ALLOWED_EXTENSIONS = set(
        SUPPORTED_EXTENSIONS['office'] + SUPPORTED_EXTENSIONS['documents'] + SUPPORTED_EXTENSIONS['text'] +
    ...
    def validate_path(self, path: Path, base_dir: Optional[Path] = None) -> tuple[bool, str]:
        ...
        Args:
            ...
            base_dir: Optional base directory (prevents traversal outside)
        ...
        try:
            ...
            for pattern in self.DANGEROUS_PATTERNS:
                if re.search(pattern, path_str):
                    return False, f"Invalid path pattern: {path}"
    ...
    def validate_file(
        ...
        Args:
            ...
            resource_limits: Optional resource limits to enforce
...
class ExtractionCache:
    ...
    def register_ocr_cache(
        ...
        self.manifest['ocr_cache'][file_name] = {
            ...
            'output_dir': str(output_dir.relative_to(self.folder_path)),
    ...
    def get_cached_ocr_data(self, file_path: Path) -> Optional[Dict[str, Any]]:
        """Load cached OCR data if available"""
        ...
        if ext in SUPPORTED_EXTENSIONS['office']:
            json_file = ocr_dir / timestamp / f"{base_name}_{cache_info['method']}.json"
            if json_file.exists():
